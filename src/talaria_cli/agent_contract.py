...
def agent_contract(vault: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "cli": {
            ...
            "commands": [
                ...
                },
                {
                    ...
                    "layer": "notify",
                    "description": "Validate gates incl. Gaxon (axon_skills cites)",
                },
                {
                    "name": "forge_build",
                    "argv": [
                ...
                {
                    "name": "forge_instruct",
                    "argv": ["forge", "instruct", "<id>|--all-drafts", "--json"],
                    "layer": "forge",
                    "description": "Auto-bootstrap doctrine (also runs inside forge build)",
                },
                {
                    "name": "forge_run",
                    "argv": ["forge", "run", "<id>", "[--pack <id>]", "--json"],
                    "layer": "act",
                    "description": "Activation packet with skill bodies + memory (default on)",
                },
                {
                    "name": "axon_search",
                ...
                {
                    "name": "axon_pack_list",
                    "argv": ["axon", "pack", "list", "--json"],
                    "layer": "retrieve",
                    "description": "List curated skill packs (mission sets)",
                },
                {
                    "name": "axon_pack_show",
                    "argv": ["axon", "pack", "show", "<id>", "--json"],
                    "layer": "retrieve",
                    "description": "Show one skill pack",
                },
                {
                    "name": "memory_retrieve",
                    "argv": ["memory", "retrieve", "<query>", "--json"],
                    "layer": "retrieve",
                    "description": "Search memory/ Markdown for Act context",
                },
                {
        ...
        "rules_for_agents": [
            ...
            "Specialized work: talaria forge run <id> [--pack software-delivery] --json (skills_hydrated + memory by default); cite axon_skills; forge check --require-axon",
            ...
            "Retrieve skills via talaria axon search / axon pack / memory retrieve",
